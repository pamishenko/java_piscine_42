...
public class Program {
	...
	public static void main(String[] args) throws UserNotFoundException {
		...
		System.out.println(ANSI_CYAN + "Try get user by corrupted index" + ANSI_RESET);
		userList.getUserByIndex(100500); // В этом месте бросится исклюыение т.к. такого польщователя нет
