...
public class Program
{
    ...
    public static void main( String[] args ) throws IOException, SQLException, NotSavedSubEntityException {
        ...
        User creator = new User(1L, "ttanja", "pa55", new ArrayList(), new ArrayList());
        User author = creator;
        Chatroom room = new Chatroom(2L, "Random", creator, new ArrayList());
        Message message = new Message(null, author, room, "Hello!!! It is saved message!", LocalDateTime.now());
        messageRepository.save(message);
        System.out.println(message.getId());

        author = new User(100500L, "FakeUser", "pa55", new ArrayList(), new ArrayList());
        room = new Chatroom(2L, "Smocking", creator, new ArrayList());
        message = new Message(null, author, room, "Hello!!! It is saved message!", LocalDateTime.now());
        messageRepository.save(message);
    ...
    static void runStatement(Connection connection, String fileName) throws FileNotFoundException {
        String filePath = System.getProperty("user.dir") + "/day05/ex02/Chat/src/main" + fileName;
